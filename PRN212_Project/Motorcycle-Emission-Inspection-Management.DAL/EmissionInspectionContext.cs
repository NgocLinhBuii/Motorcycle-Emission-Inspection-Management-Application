...
using Motorcycle_Emission_Inspection_Management.BLL.Entities;
using System;
using System.Collections.Generic;

namespace Motorcycle_Emission_Inspection_Management.BLL;
...
public partial class EmissionInspectionContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__Inspecti__FBDF78C95C614AEA");
        ...
        {
            entity.HasKey(e => e.StationId).HasName("PK__Inspecti__E0D8A6DD6020F97A");

            entity.HasIndex(e => e.Email, "UQ__Inspecti__A9D1053443C4E11B").IsUnique();
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Logs__5E5499A8FFD1A4FB");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E324A3982BA");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACC8779D7F");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534F3138CB0").IsUnique();
        ...
        {
            entity.HasKey(e => e.VehicleId).HasName("PK__Vehicles__476B54B2045DC4E5");

            entity.HasIndex(e => e.PlateNumber, "UQ__Vehicles__03692624DAEEC1CE").IsUnique();
